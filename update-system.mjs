...
const CANONICAL_REPO = 'https://github.com/ebAutomationAi/my-career-ops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/ebAutomationAi/my-career-ops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/ebAutomationAi/my-career-ops/releases/latest';
