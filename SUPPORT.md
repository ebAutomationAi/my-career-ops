...
| Question type                 | Where                                                                                                                         |
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| **Bug** (something is broken) | [GitHub Issues](https://github.com/ebAutomationAi/my-career-ops/issues) — use the Bug Report template                         |
| **Feature idea**              | [GitHub Issues](https://github.com/ebAutomationAi/my-career-ops/issues) — use the Feature Request template                    |
| **How do I...?**              | [GitHub Discussions](https://github.com/ebAutomationAi/my-career-ops/discussions) or [Discord](https://discord.gg/8pRpHETxa4) |
| **Setup help**                | Check [docs/SETUP.md](docs/SETUP.md) first, then ask in [Discord](https://discord.gg/8pRpHETxa4)                              |
| **Security vulnerability**    | Email eb.automation.ai@gmail.com — see [SECURITY.md](SECURITY.md)                                                                         |
