...
- **[@piscespieces](https://github.com/piscespieces)** (Andres Urdaneta) — Docs architect. Maintains the getting-started guides at [career-ops-docs.vercel.app](https://career-ops-docs.vercel.app). Shipped [PR #286](https://github.com/ebAutomationAi/my-career-ops/pull/286) (portals cleanup). Authored the comparative analysis that defines what career-ops is vs. isn't.

## Shipping with the project

- **[@CURT1S03](https://github.com/CURT1S03)** (Curtis) — LaTeX/Overleaf CV export ([PR #362](https://github.com/ebAutomationAi/my-career-ops/pull/362), merged — resolves [#47](https://github.com/ebAutomationAi/my-career-ops/issues/47))
- **[@vivek-gite](https://github.com/vivek-gite)** — A16Z provider support ([PR #271](https://github.com/ebAutomationAi/my-career-ops/pull/271), in review)
